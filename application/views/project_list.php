...
<style>
    .project-list-page .table {
        margin-bottom: 0;
        width: 100% !important;
    }

    .project-list-page .table thead th {
        background: #f8fafc;
        border-top: none;
    ...
    .project-list-page .table tbody td {
    ...
    .project-list-page .table tbody tr:hover td {
        background: #f8fafc;
    }

    .project-list-page .theme-card-body > .table-responsive,
    .project-list-page .theme-card-body > .data-table-container {
        margin: 0 !important;
    }
    ...
    .project-list-page .year-card.filter-year-card {
        cursor: pointer;
        transition: border-color 0.15s ease, box-shadow 0.15s ease;
    }

    .project-list-page .year-card.filter-year-card:hover {
        border-color: var(--berps-primary, #2563eb);
        box-shadow: 0 2px 8px rgba(37, 99, 235, 0.12);
    }

    .project-list-page .year-card.filter-year-card.is-active {
        border-color: var(--berps-primary, #2563eb);
