...
<style>
    ...
    .client-list-page .table tbody td {
    ...
    .client-list-page .table tbody tr:hover td {
        background: #f8fafc;
    }

    .client-list-page .client-name-link {
        font-weight: 700;
        color: var(--berps-primary, #2563eb);
    ...
    .client-list-page .portal-enabled {
        color: var(--berps-success, #16a34a);
    }

    .client-list-page .portal-disabled {
        color: var(--berps-text-muted, #6b7280);
    }
    ...
    .client-list-page .status-inactive {
        color: var(--berps-danger, #dc2626);
    }

    .client-list-page .status-prospect,
    .client-list-page .status-donation {
        color: var(--berps-info, #2563eb);
    }

    .client-list-page .dataTables_wrapper .dataTables_filter,
    .client-list-page .dataTables_wrapper .dataTables_length,
    .client-list-page .dataTables_wrapper .dataTables_info,
    .client-list-page .dataTables_wrapper .dataTables_paginate {
        font-size: 13px;
        color: #4b5563;
    }
    ...
    .client-list-page .dataTables_wrapper .dataTables_filter input:focus {
        outline: none;
        border-color: #6366f1;
    ...
    .client-list-page .stat-card.filter-status-card {
        cursor: pointer;
        transition: border-color 0.15s ease, box-shadow 0.15s ease;
        text-align: left;
        border: 1px solid var(--berps-border, #e5e7eb);
        background: #fff;
    }

    .client-list-page .stat-card.filter-status-card:hover {
        border-color: var(--berps-primary, #2563eb);
        box-shadow: 0 2px 8px rgba(37, 99, 235, 0.12);
    }

    .client-list-page .stat-card.filter-status-card.is-active {
        border-color: var(--berps-primary, #2563eb);
        box-shadow: 0 0 0 2px rgba(37, 99, 235, 0.15);
    }

    .client-list-page .theme-card-body > .table-responsive {
        margin: 0 !important;
        padding: 0 4px;
    }

    .client-list-page .dataTables_wrapper {
        padding: 0 8px 8px;
    }
</style>
