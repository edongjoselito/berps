            ...
            <div class="container-fluid knowledge-base-page">
                ...
                <div class="kb-hero">
                    <div class="kb-hero__content">
                        ...
                        <h1 class="kb-hero__title">Client Knowledge Base <span class="books-bounce">📚</span></h1>
                        <p class="kb-hero__subtitle">Browse published articles, FAQs, and attached PDF guides. This client area is read-only and designed for quick viewing.</p>
                    </div>
                </div>
