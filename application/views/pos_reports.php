            ...
            <div class="content">
                <div class="container-fluid pos-reports-page">
                    <style>
                        ...
                        .pos-reports-page .pr-hero::before {
                            content: '';
                            position: absolute;
                            top: -50%;
                            right: -10%;
                        ...
                        .pos-reports-page .pr-hero::after {
                            content: '';
                            position: absolute;
                            bottom: -60%;
                            right: 15%;
                        ...
                        .pos-reports-page .pr-hero__content {
                            position: relative;
                            z-index: 1;
                        }

                        .pos-reports-page .pr-hero__eyebrow {
                            display: inline-flex;
                            align-items: center;
                            gap: 6px;
                            margin-bottom: 8px;
                        ...
                        .pos-reports-page .pr-hero__eyebrow i {
                            font-size: 1rem;
                        }

                        .pos-reports-page .pr-hero__title {
                            margin: 0 0 4px 0;
                            color: #fff;
                        ...
                        .pos-reports-page .pr-hero__subtitle {
                            margin: 0;
                        ...
                        .pos-reports-page .pr-hero__actions {
                            display: flex;
                            align-items: center;
                            flex-wrap: wrap;
                            gap: 10px;
                        ...
                        .pos-reports-page .pr-hero-btn:hover,
                        .pos-reports-page .pr-hero-btn:focus {
                        ...
                        .pos-reports-page .pr-hero-btn--solid {
                        ...
                        .pos-reports-page .pr-hero-btn--solid:hover,
                        .pos-reports-page .pr-hero-btn--solid:focus {
                            background: #fff;
                            color: #065f46;
                        }

                        /* Chart bounce animation */
                        .pos-reports-page .chart-bounce {
                    ...
                    <div class="pr-hero">
                        <div class="pr-hero__content">
                            ...
                            <h1 class="pr-hero__title"><?= htmlspecialchars($page_title ?? 'POS Reports', ENT_QUOTES, 'UTF-8'); ?> <span class="chart-bounce">📈</span></h1>
                            <p class="pr-hero__subtitle"><?= htmlspecialchars($page_subtitle ?? '', ENT_QUOTES, 'UTF-8'); ?></p>
                        </div>
                        <div class="pr-hero__actions">
                            <a class="pr-hero-btn" href="<?= base_url('Pos/posNewTransaction'); ?>">
                                <i class="mdi mdi-plus-box-outline"></i>
                                <span>New Sale</span>
                            </a>
                            <a class="pr-hero-btn pr-hero-btn--solid" href="<?= base_url('Pos/posTransactionHistory'); ?>">
