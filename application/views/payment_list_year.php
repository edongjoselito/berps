          ...
          <div class="ms-panel">
            ...
            <form method="post">
                <div class="col-xl-3 col-md-12 mb-3">
                    ...
                    <button class="btn btn-primary float-left" name="submit" type="submit">Submit</button>
                </div>
                      ...
                      <td><a href="<?= base_url(); ?>Page/customerHistory?customer=<?php echo $row->Customer; ?>"><?php echo $row->Customer; ?></a></td>
                        ...
                        <a href="<?= base_url(); ?>Page/updatePayment?id=<?php echo $row->paymentID; ?>">Edit</a> | <a href="<?= base_url(); ?>Page/deletePayment?id=<?php echo $row->paymentID; ?>">Delete</a>
											 <!-- <button type="button" class="btn btn-primary btn-sm">
												<a href="<?= base_url(); ?>Page/updateEnrollment?id=<?php echo $row->paymentID; ?>"><b><i class="mdi mdi-account-settings-variant mr-1"></i> Edit</b></a>
											</button>
											
											<button type="button" class="btn btn-danger btn-sm">
												<a href="<?= base_url(); ?>Page/deleteEnrollment?id=<?php echo $row->paymentID; ?>"><b><i class="mdi mdi-account-settings-variant mr-1"></i> Delete</b></a>
											</button> -->
										  </td>
										  <?php
