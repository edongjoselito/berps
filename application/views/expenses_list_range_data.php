        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel">
            <div class="ms-panel-header ms-panel-custome">
              <h6>Expenses List</h6>
              <a href="#expense" class="text-blue" data-toggle="modal"><i class="flaticon-pencil"></i> Add New Expense</a>
            </div>
            ...
            <table id="table" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <?php
                      ...
                      <?php if($this->session->userdata('level')==='Admin'){ ?>
                        <a href="<?= base_url(); ?>Page/updateExpenses?id=<?php echo $row->expensesid; ?>">Edit</a> | <a href="<?= base_url(); ?>Page/deleteExpense?id=<?php echo $row->expensesid; ?>">Delete</a>
                  ...
                  <h4>Total Expenses: <span style="font-weight: bold; ">
    <?php echo isset($data1[0]->Total) ? number_format($data1[0]->Total, 2) : '0.00'; ?>
</span></h4>
    ...
    <div class="modal-dialog ms-modal-dialog-width">
      <div class="modal-content ms-modal-content-width">
        <div class="modal-header  ms-modal-header-radius-0">
          <h4 class="modal-title text-white">New Expense</h4>
              ...
              <form class="needs-validation" method="post" action="<?= base_url(); ?>Page/addExpenses" novalidate>
                <div class="form-row">
                    <div class="col-md-6 mb-6">
                      <label for="validationCustom020">Date</label>
                      <div class="input-group">
                        <input type="date" class="form-control" name="ExpenseDate" id="validationCustom020" required>
                    ...
                    <div class="col-md-6 mb-6">
                      <label for="validationCustom020">Amount</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="Amount" id="validationCustom020" required>
                        <!-- <div class="valid-feedback">
                          Looks good!
                        </div> -->
                      </div>
...
<div class="form-row">
                    <div class="col-md-6 mb-6">
                      <label for="validationCustom020">Description</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="Description" id="validationCustom020" required>
                        <!-- <div class="valid-feedback">
                          Looks good!
                        </div> -->
                      </div>
                    ...
                    <div class="col-md-6 mb-6">
                    <label for="validationCustom010">Category</label>
                    <div class="input-group">
                      <select class="form-control" name="Category" id="validationCustom010">
                        <option></option>
                        <option>Courier Fee</option>
                        <option>Insurance</option>
                        <option>Meals and Snacks</option>
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom050">Responsible</label>
                    <div class="input-group">
                      <input type="text" class="form-control" name="Responsible" id="validationCustom050"  required>

                    </div>
                  </div>
                </div>

              <input type="submit" name="submit" class="btn btn-primary mt-4 d-inline w-20" value="Submit">  
              <input type="reset" name="reset" class="btn btn-warning mt-4 d-inline w-20" value="Reset"> 
