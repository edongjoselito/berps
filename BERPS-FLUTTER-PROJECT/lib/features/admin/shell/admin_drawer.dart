...
/// Admin navigation drawer — mirrors the staff drawer styling. "Navigation"
/// items switch the bottom-nav index; "Management" items push detail screens.
class AdminDrawer extends StatelessWidget {
  const AdminDrawer({
    ...
    required this.onSelectEmployeeTasks,
    required this.onSelectAccomplishments,
  ...
  final VoidCallback onSelectEmployeeTasks;
  final VoidCallback onSelectAccomplishments;
